import svgPaths from "./svg-57o73oo3te";

function Cardiology() {
  return (
    <div
      className="absolute aspect-[16/16] left-0 right-0 top-0"
...
function Favorite() {
  return (
    <div className="h-6 relative shrink-0 w-[11px]" data-name="favorite">
      <svg
        className="block size-full"
        fill="none"
        preserveAspectRatio="none"
...
function AutoLayoutHorizontal7() {
  return (
    <div
      className="box-border content-stretch flex flex-row items-center justify-between p-0 relative shrink-0 w-[383px]"
      data-name="Auto Layout Horizontal"
    >
